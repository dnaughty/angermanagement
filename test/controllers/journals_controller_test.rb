...
class JournalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal" do
    assert_difference('Journal.count') do
      post journals_url, params: { journal: { incident_id: @journal.incident_id, title: @journal.title } }
    end
  ...
  test "should update journal" do
    patch journal_url(@journal), params: { journal: { incident_id: @journal.incident_id, title: @journal.title } }
