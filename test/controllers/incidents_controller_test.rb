...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { kind: @incident.kind, location: @incident.location, moodprev: @incident.moodprev, specloc: @incident.specloc } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { kind: @incident.kind, location: @incident.location, moodprev: @incident.moodprev, specloc: @incident.specloc } }
